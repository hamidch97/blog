...
class ProfilPageForm(forms.ModelForm):
    class Meta:
        model = Profil
...
class EditPofilForm(UserChangeForm):
    ...
    is_superuser = forms.CharField(
        max_length=30, widget=forms.CheckboxInput(attrs={'class': 'form-check'}))
...
class PasswordChangingForm(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(
        max_length=30, widget=forms.PasswordInput(attrs={'class': 'form-control', 'type': 'password'}))
